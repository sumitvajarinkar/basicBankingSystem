...
<class class="welcome">
        <h2>
            <img src="logo/t1.png" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> <img
                src="logo/t2.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
